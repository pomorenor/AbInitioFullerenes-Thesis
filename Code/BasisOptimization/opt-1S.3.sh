...
#RX1=`gawk ' ($1~/^rx1$/ ){print $2} '  $1` 
#RY1=`gawk ' ($1~/^ry1$/ ){print $2} '  $1` 
#RZ1=`gawk ' ($1~/^rz1$/ ){print $2} '  $1` 
#RX2=`gawk ' ($1~/^rx2$/ ){print $2} '  $1` 
#RY2=`gawk ' ($1~/^ry2$/ ){print $2} '  $1` 
#RZ2=`gawk ' ($1~/^rz2$/ ){print $2} '  $1` 
#RX3=`gawk ' ($1~/^rx3$/ ){print $2} '  $1` 
#RY3=`gawk ' ($1~/^ry3$/ ){print $2} '  $1` 
#RZ3=`gawk ' ($1~/^rz3$/ ){print $2} '  $1` 
